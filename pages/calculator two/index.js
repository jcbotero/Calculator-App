...
class CalTwo extends React.Component {
    constructor(props) {
        super(props);
     ...
     operacion() {
       ...
       render() {
            ...
            return (
            <>
             <div className={styles.calone} id={styles.caltwo}>
                <div>
                    <input ref={this.show} className={styles.input2}  value=""/>
                </div> {/*  ref={this.show} es un sinonimo del .documentgetbyid  */}
                <div className={styles.gridcal} id={styles.gridcal2}>
                    <div className={styles.botones} id={styles.botones2}>
                    ...
                    <div className={styles.botonesf} id={styles.botonesf2}>
                        <button className={styles.reset}  onClick={this.clear} id={styles.reset2}>RESET</button>
                        <button className={styles.equal} onClick={this.operacion} id={styles.equal2}>=</button>
                    </div>
                </div>
             </div>          
            </>
